var GKWebConnectorLayerV5 = GK_WebConnectorLayer.extend({
    //***********变量*************
    mWidth: null,
    mHeight: null,
    mXOffset: null,
    ...
    createLayer: function(aTitle, aWaitDuration, aRoomGroup) {
        ...
        nodeLink.href = "http://game.goooku.com/led-web/css/screenBoweinian.css";
    ...
    showLayer: function(aCallback) {
        ...
        nodeli.style.cssText =
            ...
            'background:url("http://game.goooku.com/led-web/img/boweinian/bg.png");';
        ...
        for(var i = 0; i < 16; i += 1) {
            ...
            divTemp.innerHTML =
                ...
                '<img id="' + i + '" src="http://game.goooku.com/led-web/img/boweinian/whiteGrid.png"/>' +
                '</div>' +
                '</li>';
        ...
        for(var j = 15; j >= 0; j--) {
            if(this.mRoomGroup.charAt(j) == 1) {
                _.el('#' + j).attr('src', 'http://game.goooku.com/led-web/img/boweinian/redGrid.png');
            }
        }
    ...
    addUser: function(aUserIdx, aAvatarUrl, aSex) {
        var activityWidth = Math.floor((_.el('.activity')[0].clientWidth) / 8.5);
        var sexIcon = '';
        if(aSex == '1') {
            sexIcon = 'http://game.goooku.com/led-web/img/boweinian/male.png';
        } else if(aSex == '2') {
            sexIcon = 'http://game.goooku.com/led-web/img/boweinian/female.png';
        } else {
            sexIcon = 'http://game.goooku.com/led-web/img/boweinian/female.png';
        }
